  ...
  return (
    <div className="generate-workbench">
      ...
      {selectedPage ? characterPackages.isError ? (
        ...
        {(generate.isError || startBatch.isError || actionError) && <p className="form-error" role="alert"><CircleAlert size={14} />{(generate.error ?? startBatch.error ?? actionError)?.message}</p>}
