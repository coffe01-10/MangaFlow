...
以下引用的审查结论和旧验收记录为历史基线；当前合并状态以上述 PR #6 记录及最新 TodoList 勾选为准。
...
| H. 主分支可靠性收口 | 进行中 | PR #6 已合并安全与调度修复；继续完成 P1-8、P2-8、其他序号范围与独立性能门禁，并补齐独立队列/数据库和浏览器验收 |
...
以下 P1-7、P1-9～P1-12 的代码修复已由 PR #6 合并，独立集成验收仍待完成；P1-8、P2-8 尚未修复。详细复现与原验收标准以 [`roadmap.md`](roadmap.md) 同编号为准。
