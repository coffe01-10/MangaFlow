...
FPS 两轮 exit 0（avg 143.55 / 143.15，1% low 140.85）。行为回归门禁：web Vitest **41 文件 429 项全过**、ESLint 干净、Next 生产构建通过。全部路由对比修复前稳升或持平（storyboard 81/84→91/90、workflow 87→92、/ 96→98）。
