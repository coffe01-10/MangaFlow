...
6. Return concrete GitHub review comments for defects. After two formal repair rounds with a merge blocker still present, stop delegating the same defect and let the lead take over. Record that the original agent has stopped before editing its branch.
